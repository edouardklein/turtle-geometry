...
(defsynonym (timed-color) (interval times &key (world *world*) (turtle *turtle*))
  (dotimes (x times)
    (color (vec4f (/ x times) 0.0 0.0 1.0) :world world :turtle turtle)
    (left pi/2 :world world :turtle turtle)
    (sleep interval))
  (force 0 :world world :turtle turtle)
  (velocity 0 :world world :turtle turtle))
